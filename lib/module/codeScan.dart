...
class CodeDetectWidget extends StatefulWidget {
  @override
  _CodeDetectWidgetState createState() => new _CodeDetectWidgetState();
}

class _CodeDetectWidgetState extends State<CodeDetectWidget> {
  File _file;
...
//  FirebaseVisionFaceDetector
  ...
  Widget _buildImage() {
    return SizedBox(
      ...
      child: new Center(
        child: _file == null
            ? Text('Sorry, This module is not working now!',
